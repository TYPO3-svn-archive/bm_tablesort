...
fdTableSort = {
        ...
        init: function(tableId) {
                ...
                for(var k = 0, tbl; tbl = tables[k]; k++) {
                        ...
                        thElem = null;
                        var thovertextbefore = "Sort on \u201c";
                        var thovertextafter = "\u201d";
                        if (sortHoverTextbefore!='') {
                          thovertextbefore = sortHoverTextbefore;
                        }
                        if (sortHoverTextafter!='') {
                          thovertextafter = sortHoverTextafter;
                        }
                        ...
                        for(var c = 0;c < workArr.length;c++) {
                                for(var i = 0;i < workArr[c].length;i++){
                                        ...
                                        if(workArr[c][i].className.match('sortable')) {
                                                ...
                                                aclone.title = thovertextbefore + thtext + thovertextafter;
